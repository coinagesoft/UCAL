      ...
      <li className="nav-item dropdown h-100">
        <div
          className={`${getLinkClassName({
            active,
            isHome,
          })} dropdown-toggle h-100 d-flex align-items-center gap-1 ${styles.dropdownTrigger}`}
          data-bs-toggle="dropdown"
        >
          <span>{label}</span>

        <i className ={`ri-arrow-drop-down-line ${styles.dropdownIcon}`}></i>
